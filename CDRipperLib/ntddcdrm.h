...
#define IOCTL_CDROM_UNLOAD_DRIVER        CTL_CODE(IOCTL_CDROM_BASE, 0x0402, METHOD_BUFFERED, FILE_READ_ACCESS)
	...
	/*
	00204: #define CTL_CODE( DeviceType, Function, Method, Access ) ( \
00205: ((DeviceType) << 16) | ((Access) << 14) | ((Function) << 2) | (Method) \
00206: )

00222: #define METHOD_BUFFERED 0
00223: #define METHOD_IN_DIRECT 1
00224: #define METHOD_OUT_DIRECT 2
00225: #define METHOD_NEITHER 3

00124: #define FILE_DEVICE_CD_ROM 0x00000002
define FILE_READ_ACCESS ( 0x0001 ) // file & pip
