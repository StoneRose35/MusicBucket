...
namespace MP3Tagger.Classes
{
    ...
    public class ID3v23 : ID3Tag,IID3v23
    {
        ...
        private const string COMMENTS = "TIT1";
        ...
        public System.Drawing.Image FrontCover
        {
            ...
            set
            {
                ...
                {
                    imgTF = _frames[_frontcoverIndex] as ImageTagFrame;
                }
                else
                {
                    imgTF = new ImageTagFrame();
                    imgTF.FrameHeader = COVER;
                    imgTF.Flags = new byte[] { 0, 0 };
                    _frontcoverIndex = _frames.Count;
                    _frames.Add(imgTF as TagFrame);
                }
        ...
        public override int Write(System.IO.Stream stream)
        {
            ...
            foreach (TagFrame tf in _frames)
            {
        ...
        public override bool Read(System.IO.Stream stream)
        {
            ...
            singlebyte = (byte)stream.ReadByte();
            extendedheaderpresent = (singlebyte & 64) != 0;
            bbfr = new byte[4];
                ...
                if (!((frame.Flags[1] & 128) != 0 || (frame.Flags[1] & 64) != 0))//((frameflags[1] & 128) != 0 || (frameflags[1] & 64) != 0) // frame is compressed or encrypted, no treating these cases yet
                {
                    switch (framename)
                    {
                        ...
                        case COVER:
                            ...
                            ImageTagFrame imgtf = new ImageTagFrame(frame);
